...
export class InventoryListComponent implements OnInit {
  ...
  public addReceiptItems() {
    this.inventoryElements.unshift(...[{ name: 'Müllermilch', price: 0.59, bestBefore: '06-06-19', addedAt: moment().locale("de").format('Do MMMM YYYY [um] hh:mm [Uhr]') },
  ...
  removeInventoryItem(idx: number) {
    let inventoryItemToBeRemoved = this.inventoryElements.filter((x, i) => i === idx);
