  ...
  ngOnInit() {
    ...
    if (items.length === 0) {
      [
        ...
        { name: 'Bio-Bananen, 5 Stück', price: 1.99, bestBefore: '30-09-20', addedAt: '6. Mai 2019 um 08:00 Uhr', userCheckRecommended=true, imageUrl='https://www.kochschule.de/sites/default/files/images/kochwissen/440/banane.jpg'},
        { name: 'RAUCH Happy Day 100% Apfel Apfelsaft 2L', price: 1.99, bestBefore: '14-07-20', addedAt: '12. Mai 2019 um 08:00 Uhr', userCheckRecommended=true, imageUrl='https://files.billa.at/files/artikel/00-400975_01__600x600.jpg'},
